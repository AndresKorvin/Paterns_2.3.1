...
public class DataGenerator {
    public static String[] allTownList = new String[]{
    ...
    public static String[] correctTownList = new String[]{
            ...
            "Курган", "Курск", "Липецк", "Магадан", "Мурманск", "Нижний Новгород", "Великий Новгород",
            "Новосибирск", "Омск", "Оренбург", "Орёл", "Пенза", "Псков", "Ростов-на-Дону", "Рязань", "Самара", "Саратов",
    ...
    public static String generateCity() {
        String city = correctTownList[new Random().nextInt(allTownList.length)];
        return city;
    }
